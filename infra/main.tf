...
#   key_name                  = "17_3"
#   instance_type             = "t2.medium"
#   tag_name                  = "Ansible:Ubuntu-EC2"
#   subnet_id                 = module.vpc.public_subnet_az1_id
#   sg_for_ansible            = [module.security_groups.ec2_ansible_security_group_id]
#   enable_public_ip_address  = true
#   user_data_install_ansible = templatefile("./modules/ansible-runner-script/ansible-installer.sh", {})
